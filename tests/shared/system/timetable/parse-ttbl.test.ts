...
[regular, up]    MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ ____F__ ____F__
...
[regular, down]  MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ MTWTF__ ____F__ ____F__
...
[regular, up]    _____S_ _____S_ _____S_ _____S_ _____S_ _____S_ _____S_ _____S_
...
[regular, down]  _____S_ _____S_ _____S_ _____S_ _____S_ _____S_ _____S_ _____S_
...
[regular, up]    ______S ______S ______S ______S ______S ______S ______S
...
[regular, down]  ______S ______S ______S ______S ______S ______S ______S
...
describe("parseTtbl", () => {
  it("works correctly", () => {
    ...
    const isExclusivelyFriday = (x: FullTimetableEntry) =>
      x.weekdayRange.asString() === "____F__";

    expect(timetable.entries.length).toBe(52);
    expect(timetable.entries.filter(isUp).length).toBe(27);
    expect(timetable.entries.filter(isDown).length).toBe(25);
    expect(timetable.entries.filter(isExclusivelyFriday).length).toBe(4);
  });
});
